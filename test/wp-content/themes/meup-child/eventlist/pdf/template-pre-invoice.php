...
<!-- DEBUG: Current PDF Mode: <?php echo $pdf_mode; ?> -->
    ...
    <style>
        @page { margin: <?php echo ($pdf_mode === "default") ? "3cm" : (($pdf_mode === "modern") ? "1cm" : "2cm"); ?>; }
        * { margin: 0; padding: 0; box-sizing: border-box; }
        
        body {
            font-family: "DejaVu Sans", Arial, sans-serif;
            font-size: <?php echo ($pdf_mode === "default") ? "16px" : (($pdf_mode === "modern") ? "9px" : "12px"); ?>;
            line-height: 1.4;
            color: #202124;
        }
        ...
        .ticket-title {
            font-size: <?php echo ($pdf_mode === "default") ? "24px" : (($pdf_mode === "modern") ? "14px" : "18px"); ?>;
            font-weight: normal;
