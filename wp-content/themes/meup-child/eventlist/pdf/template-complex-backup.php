...
if ( empty( $pdf_mode ) ) { $pdf_mode = 'enhanced'; }
?>
<!DOCTYPE html>
<html>
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
<!-- DEBUG: Current PDF Mode: <?php echo $pdf_mode; ?> -->
    <title><?php echo sprintf( esc_html__( 'Ticket #%s', 'eventlist' ), $ticket['ticket_id'] ); ?></title>
    
    <?php if ( $pdf_library === 'dompdf' ): ?>
    <!-- Dompdf Optimized CSS -->
    <style>
        @page { margin: <?php echo ($pdf_mode === "default") ? "3cm" : (($pdf_mode === "modern") ? "1cm" : (($pdf_mode === "invoice") ? "2.5cm" : "2cm")); ?>; }
        * { margin: 0; padding: 0; box-sizing: border-box; }
        
        body {
            font-family: "DejaVu Sans", Arial, sans-serif;
            font-size: <?php echo ($pdf_mode === "default") ? "16px" : (($pdf_mode === "modern") ? "9px" : (($pdf_mode === "invoice") ? "11px" : "12px")); ?>;
            line-height: 1.4;
            color: #202124;
        }
        ...
        .ticket-title {
            font-size: <?php echo ($pdf_mode === "default") ? "24px" : (($pdf_mode === "modern") ? "14px" : (($pdf_mode === "invoice") ? "20px" : "18px")); ?>;
            font-weight: normal;
        ...
        .section-title {
            font-size: <?php echo ($pdf_mode === "default") ? "18px" : (($pdf_mode === "modern") ? "10px" : "14px"); ?>;
            font-weight: bold;
        ...
        .event-name {
            font-size: <?php echo ($pdf_mode === "default") ? "20px" : (($pdf_mode === "modern") ? "12px" : "16px"); ?>;
            color: <?php echo ! empty( $ticket['color_content_ticket'] ) ? $ticket['color_content_ticket'] : '#202124'; ?>;
            margin-bottom: 8px;
        }
        ...
        <div class="header <?php echo $pdf_library === 'mpdf' ? 'clearfix' : ''; ?>">
            <?php if ( $pdf_library === 'mpdf' ): ?>
                <div class="header-left">
                    ...
                    <div class="template-mode" style="font-size: 10px; color: #666; margin-top: 5px;">Template: <?php echo ucfirst($pdf_mode); ?> Mode</div>
